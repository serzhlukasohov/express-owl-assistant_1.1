...
const setContextConfigCommand = createCommand('context-config', ['cc'], `Sets the number of relevant documents to return from the context vector store.
    Arguments: <number of documents> (Default: 6)
    Example: /context-config 10`, async (args, output) => {
...
//# sourceMappingURL=setContextConfigCommand.js.map