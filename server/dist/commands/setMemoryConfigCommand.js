...
const setMemoryConfigCommand = createCommand('memory-config', ['mc'], `Sets the number of relevant documents to return from the memory vector store.
    Arguments: <number of documents> (Default: 4)
    Example: /memory-config 10`, async (args, output) => {
...
//# sourceMappingURL=setMemoryConfigCommand.js.map