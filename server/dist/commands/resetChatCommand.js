...
const resetChatCommand = createCommand('reset', [], 'Resets the chat and starts a new conversation - This clears the memory vector store and the buffer window memory.', async (_args, output) => {
...
//# sourceMappingURL=resetChatCommand.js.map